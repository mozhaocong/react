export const areaCodeSourceData = [
	...
	{ label: 'Caribbean Netherlands +599', value: '599' },
...
const areaCodeObje = {}
export const areaCodeData = areaCodeSourceData.filter((item) => {
	if (areaCodeObje[item.value]) {
		return false
	} else {
		areaCodeObje[item.value] = true
		return true
	}
})
